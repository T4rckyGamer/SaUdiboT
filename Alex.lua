...
function DevBot(msg) 
local hash = database:sismember(bot_id.."Alex:Sudo:User", msg.sender_user_id_) 
if hash or DevAlex(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."Alex:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevAlex(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Alex:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevAlex(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."Alex:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevAlex(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."Alex:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevAlex(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Alex:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevAlex(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."Alex:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevAlex(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Alex:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."Alex:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Alex:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Alex:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Alex:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
if tonumber(user_id) == tonumber(909279851) then  
var = "مطور الاساسي"
elseif tonumber(user_id) == tonumber(909279851) then  
var = "مطور الاساسي"
...
var = "البوت"
elseif database:sismember(bot_id.."Alex:Sudo:User", user_id) then
var = database:get(bot_id.."Alex:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."Alex:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."Alex:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Alex:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."Alex:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Alex:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."Alex:Manager"..chat_id, user_id) then
var = database:get(bot_id.."Alex:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."Alex:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."Alex:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."Alex:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."Alex:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."Alex:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."Alex:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."Alex:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Alex:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Alex:GBan:User",User_id) then
Var = true
else
Var = false
end
...
database:sadd(bot_id..'Alex:Chek:Groups',idg) 
database:set(bot_id.."Alex:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Alex:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."Alex:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."Alex:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."Alex:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."Alex:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
...
function Alex_Files(msg)
for v in io.popen('ls Alex_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Alex_Files/"..v)
if plugin.Alex and msg then
pre_msg = plugin.Alex(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function Alex_Started_Bot(msg,data) 
if msg then
...
database:incr(bot_id..'Alex:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'Alex:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
database:set(bot_id..'Alex:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'Alex:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'Alex:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."Alex:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."Alex:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Alex:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."Alex:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."Alex:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."Alex:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Alex:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Alex:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Alex:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."Alex:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Alex:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."Alex:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."Alex:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."Alex:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."Alex:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."Alex:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."Alex:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."Alex:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."Alex:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."Alex:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."Alex:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."Alex:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
if text and database:get(bot_id.."Alex:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
...
database:set(bot_id.."Alex:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
...
database:del(bot_id.."Alex:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
...
if text and text:match("^حظر عام @(.*)$")  and DevAlex(msg) then
...
if text and text:match("^الغاء العام @(.*)$") and DevAlex(msg) then
...
if text and text:match("^رفع مطور @(.*)$") and DevAlex(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevAlex(msg) then
...
database:del(bot_id.."botss:Alex:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Alex:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعددة") and DevAlex(msg) then
 
local list = database:smembers(bot_id.."botss:Alex:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Alex:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Alex:Add:Rd:Sudo:Text1"..v) 
...
if database:get(bot_id.."botss:Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = database:get(bot_id.."botss:Alex:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = database:get(bot_id.."botss:Alex:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then
local Text = database:get(bot_id.."botss:Alex:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Alex:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Alex:Add:Rd:Sudo:Text2"..text)   
...
send(msg.chat_id_, msg.id_,'◈︙ الرفع معطل من قبل المنشئين .')
return false
end
function Function_Alex(extra, result, success)
...
if not Constructor(msg) and database:get(bot_id.."Add:Group:Cheking"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'◈︙ الرفع معطل من المنشئين .')
return false
end
...
if database:sismember(bot_id.."Alex:Coomds"..msg.chat_id_,RTPA) then
...
if database:sismember(bot_id.."Alex:Coomds"..msg.chat_id_,text1[2]) then
...
send(msg.chat_id_, msg.id_,'◈︙ الحظر معطل من المنشئين  .')
return false
end
function Function_Alex(extra, result, success)
...
send(msg.chat_id_, msg.id_,"◈︙ البوت ليس مشرف في المجموعة.") 
return false  
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_Alex, nil)
return false
end
------------------------------------------------------------------------
...
if text then   
database:set(bot_id.."Alex:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Alex:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
local Set_Rules = database:get(bot_id.."Alex:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
for k,v in pairs(list) do
database:del(bot_id.."Alex:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."Alex:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."Alex:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."Alex:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."Alex:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."Alex:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."Alex:Add:Rd:Manager:File"..v..msg.chat_id_)
...
db = "متحركة ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمة ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ستكر ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رسالة ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صورة ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيد ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ."
elseif database:get(bot_id.."Alex:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنية ."
end
text = text..""..k.." : ("..v..") : {"..db.."}\n"
end
...
local test = database:get(bot_id.."Alex:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."Alex:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Alex:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Alex:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Alex:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Alex:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Alex:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Alex:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Alex:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Alex:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:del(bot_id.."Alex:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."Alex:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."Alex:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."Alex:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."Alex:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."Alex:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
...
database:del(bot_id.."Alex:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."Alex:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Alex:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."Alex:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'Alex:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Alex:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."Alex:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."Alex:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."Alex:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."Alex:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."Alex:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."Alex:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."Alex:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'Alex:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Alex:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, Text)
database:sadd(bot_id.."Alex:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevAlex(msg) then 
local list = database:smembers(bot_id.."Alex:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."Alex:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."Alex:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."Alex:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."Alex:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."Alex:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."Alex:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."Alex:Add:Rd:Sudo:File"..v)
...
db = " : متحركة ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:vico"..v) then
db = " : بصمة ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:stekr"..v) then
db = " : ستكر ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:Text"..v) then
db = " : رسالة ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:Photo"..v) then
db = " : صورة ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:Video"..v) then
db = " : فيد ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:File"..v) then
db = " : ملف ."
elseif database:get(bot_id.."Alex:Add:Rd:Sudo:Audio"..v) then
db = " : اغنية ."
end
text = text..""..k.." : "..v.." "..db.."\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."Alex:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Alex:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Alex:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Alex:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Alex:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Alex:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Alex:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Alex:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Alex:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:del(bot_id.."Alex:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Alex:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."Alex:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'Alex:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Alex:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."Alex:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."Alex:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."Alex:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."Alex:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."Alex:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."Alex:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."Alex:Add:Rd:Sudo:Audio"..text)
...
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Alex:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."Alex:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Alex:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Alex:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Alex:Special:User"..msg.chat_id_, result.id_)
end
else
...
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."Alex:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."Alex:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."Alex:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."Alex:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن " else mod = "" end
if database:sismember(bot_id.."Alex:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز " else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."Alex:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."Alex:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
database:del(bot_id.."Alex:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_Alex(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."Alex:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Alex:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Alex:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_Alex(extra, result, success)
if database:sismember(bot_id.."Alex:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Alex:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Alex:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."Alex:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."Alex:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
if text == (database:get(bot_id.."Alex:Name:Bot") or "سعودي") then
Namebot = (database:get(bot_id.."Alex:Name:Bot") or "سعودي")
local namebot = {
"معك السعودي امر",
"امرني",
'اهلا...',
...
send(msg.chat_id_, msg.id_, "◈︙ لست مشرف في المجموعه.") 
return false
end  
local num = 0 
...
if database:get(bot_id.."Alex:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."Alex:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."Alex:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."Alex:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقييد"     
elseif database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."Alex:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقييد"    
elseif database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقييد"    
elseif database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقييد"    
elseif database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقييد"    
elseif database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."Alex:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."Alex:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقييد"   
elseif database:get(bot_id.."Alex:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقييد"    
elseif database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."Alex:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."Alex:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."Alex:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."Alex:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."Alex:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."Alex:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."Alex:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
local NumMsg = database:get(bot_id..'Alex:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Alex:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Alex:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."aaaZaa:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."Alex:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."Alex:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'Alex:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'Alex:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Alex:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Alex:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."aaaZaa:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."Alex:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'Alex:Lock:ID:Bot'..msg.chat_id_) then
...
if text == "تنظيف المشتركين" and DevAlex(msg) then
...
database:srem(bot_id..'Alex:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevAlex(msg) then
...
database:srem(bot_id..'Alex:Chek:Groups',group[i])  
w = w + 1
end
...
download_to_file('https://raw.githubusercontent.com/T4rckyGamer/SaUdiboT/master/Alex.lua', 'Alex.lua') 
download_to_file('https://raw.githubusercontent.com/T4rckyGamer/SaUdiboT/master/start.lua', 'start.lua') 
dofile('Alex.lua')  
return false
end
...
for k,v in pairs(list) do   
NAME = 'Alex Chat'
ASAS = database:smembers(bot_id.."Alex:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."Alex:Constructor"..v)
MDER = database:smembers(bot_id.."Alex:Manager"..v)
MOD = database:smembers(bot_id.."Alex:Mod:User"..v)
link = database:get(bot_id.."Alex:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"Alex":"'..NAME..'",'
else
t = t..',"'..v..'":{"Alex":"'..NAME..'",'
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevAlex(msg) then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevAlex(msg) then
...
local Users = database:smembers('Alex:'..bot_id.."userss")
local Groups = database:smembers('Alex:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'Alex:Chek:Groups',Groups[i])  
local list1 = database:smembers('Alex:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."Alex:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('Alex:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."Alex:Constructor"..Groups[i], v)
end
local list3 = database:smembers('Alex:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."Alex:Manager"..Groups[i], v)
end
local list4 = database:smembers('Alex:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."Alex:Mod:User"..Groups[i], v)
end
database:set(bot_id.."Alex:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Alex:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
...
if text == 'القنوات' or text == 'الدعم الفني' or text == 'الدعم' or text == 'قروب المطورين' then
local Text =[[
قنوات ياقوت الرسميه💎🔴
...
{
{text = 'قناة ياقوت ', url = "https://t.me/YaqotSa1"}
},
{
{text = 'الدعم الفني ', url = "https://t.me/YaqotDevloper"}
},
{
{text = 'المطور الاساسي ', url = "https://t.me/PROTECTmnbot"}
},
}
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'Alex:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'Alex:Chek:Groups',msg.chat_id_) then
...
database:sadd(bot_id..'Alex:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'Alex:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'Alex:Start:Time'..msg.sender_user_id_,60,true)
return false
end
...
if text and not database:sismember(bot_id..'Alex:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'Alex:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'Alex:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."Alex:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."Alex:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."Alex:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."Alex:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
...
local NewCmmd = database:get(bot_id.."Alex:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
if database:get(bot_id.."Alex:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."Alex:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."Alex:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."Alex:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'Alex:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'Alex:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'Alex:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'Alex:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Alex:Chek:Groups',v)  
end
